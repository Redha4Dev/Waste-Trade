...
const mockListingData = {
    ...
    description: "High-quality blue HDPE containers, clean and shredded. Ideal for reprocessing into pipes and drums.",
    price: 4000,
    unity: "ton",
    type: "plastic",
    subType: "HDPE",
...
const EditListingPage = ({ params }: EditListingPageProps) => {
    ...
    const listingData = mockListingData;
        ...
        <div className="w-full max-w-4xl mx-auto p-4 sm:p-6 lg:p-8"> 
            ...
            <header className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">
                    Edit Listing: 
                    <span className="text-green-600 dark:text-green-400 ml-2">{listingData.title}</span>
                </h1>
            </header>
            
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                Listing ID: <code className="font-mono text-xs bg-gray-100 dark:bg-gray-800 p-1 rounded">{listingId}</code>. Modify the details below and save your changes.
            </p>
